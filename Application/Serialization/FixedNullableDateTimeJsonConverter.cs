...
public sealed class FixedNullableDateTimeJsonConverter : JsonConverter<DateTime?>
{
    ...
    {
        if (value.HasValue)
            writer.WriteStringValue(value.Value.ToString(DateTimeJsonFormats.Default, CultureInfo.InvariantCulture));
        else
