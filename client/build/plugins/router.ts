...
const ROUTE_META_PRESETS: Record<string, RouteMetaPreset> = {
  ...
  '(base)_storage_in_other_detail': { activeMenu: '/storage/in/other', hideInMenu: true },
  '(base)_storage_in_other_detail_[id]': { activeMenu: '/storage/in/other', hideInMenu: true },
  '(base)_storage_in_other_operate': { activeMenu: '/storage/in/other', hideInMenu: true },
  '(base)_storage_in_other_operate_[id]': { activeMenu: '/storage/in/other', hideInMenu: true },
  ...
  '(base)_storage_in_sales-return_detail': { activeMenu: '/storage/in/sales-return', hideInMenu: true },
  '(base)_storage_in_sales-return_detail_[id]': { activeMenu: '/storage/in/sales-return', hideInMenu: true },
  '(base)_storage_in_sales-return_operate': { activeMenu: '/storage/in/sales-return', hideInMenu: true },
  '(base)_storage_in_sales-return_operate_[id]': { activeMenu: '/storage/in/sales-return', hideInMenu: true },
