  ...
  namespace I18n {
    ...
    type Schema = {
      translation: {
        ...
        page: {
          about: I18n.PageAbout;
          afterSale: I18n.PageAfterSale;
          customer: I18n.PageCustomer;
          dashboard: I18n.PageDashboard;
          function: I18n.PageFunction;
          goods: I18n.PageGoods;
          home: I18n.PageHome;
          login: I18n.PageLogin;
          manage: I18n.PageManage;
          order: I18n.PageOrder;
          pickupTask: I18n.PagePickupTask;
          purchase: I18n.PagePurchase;
          storage: I18n.PageStorage;
        };
        request: {
          logout: string;
          logoutMsg: string;
