...
interface PurchaseStockInDetailViewProps {
  detail: Api.StockIn.Entity;
}

/** 采购入库详情内容：基本信息、业务方信息、审核信息和商品明细。 */
const PurchaseStockInDetailView = ({ detail }: PurchaseStockInDetailViewProps) => {
...
export default PurchaseStockInDetailView;
