...
export function fetchAddPurchasePlan(data?: Api.PurchasePlan.Payload) {
...
export function fetchGeneratePurchasePlan(data?: Api.PurchasePlan.Payload) {
  return request<Api.PurchasePlan.Entity>({
    data,
    method: 'post',
...
export function fetchMergePurchasePlan(data?: Api.PurchasePlan.Payload) {
  return request<Api.PurchasePlan.Entity>({
    data,
    method: 'post',
...
export function fetchUpdatePurchasePlanPurchaser(data?: Api.PurchasePlan.Payload) {
  return request<Api.PurchasePlan.Entity>({
    data,
    method: 'put',
...
export function fetchSplitOrdersPurchasePlan(data?: Api.PurchasePlan.Payload) {
  return request<Api.PurchasePlan.Entity>({
    data,
    method: 'post',
...
export function fetchSplitQuantityPurchasePlan(data?: Api.PurchasePlan.Payload) {
  return request<Api.PurchasePlan.Entity>({
    data,
    method: 'post',
...
export function fetchUpdatePurchasePlanSupplier(data?: Api.PurchasePlan.Payload) {
  return request<Api.PurchasePlan.Entity>({
    data,
    method: 'put',
...
export function fetchGetPurchasePlanSplitOrders(planId: string, params?: Api.PurchasePlan.SearchParams) {
  return request<Api.PurchasePlan.Result>({
    method: 'get',
    params,
